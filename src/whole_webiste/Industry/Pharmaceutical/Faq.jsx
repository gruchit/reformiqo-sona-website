...
function Faq({ Type }) {
  ...
  if (Type === "Cosm") {
    faqs = [
      {
        question: "What is the lead time for delivering aluminium collapsible tubes to Cosmetic and Personal care companies?",
        answer: "Because of our state-of-the-art manufacturing processes, we are able to provide aluminium collapsible tubes in a very short period of time. However, delivery can be influenced by a number of variables, including order volume, customization needs, and production capacity.",
      },
      {
        question: "What type of printing option can be expected for aluminium collapsible tubes by Cosmetic and Personal care companies?",
        answer:
      ...
      {
        question: "What type of customization possibilities exist for Cosmetic and Personal care companies using aluminium collapsible tube?",
        answer:"We, offer a range of customization options for collapsible aluminium tubes for makers of cosmetics and personal care products. These customization options include, but are not limited to, custom colours, custom design print, flexible MOQ (minimum order quantity), select cap designs and a range of fill sizes to suit customer needs.",
      },
    ];
  } else if (Type === "Nut") {
    faqs = [
      {
        question: "How can any Agro-Chemical company benefit from using aluminium collapsible tube?",
        answer: "The biggest advantage of using aluminium collapsible tube from Sona Extrusion is that our highly-efficient manufacturing processes provide superior protection against light, air and moisture for Agro-Chemical products. Additionally, aluminium collapsible tubes are cost effective, making them a popular choice for agrochemical packaging.",
      },
      {
        question: "How versatile is aluminium collapsible tube for Agro-Chemical products?",
        answer:"The aluminium used in these tubes is generally durable and suitable for containing hazardous materials, which makes them a safe option for storing a variety of agrochemical products. However, specific packaging materials might be needed for some extremely corrosive or reactive chemicals. If you want to know whether aluminium collapsible tubes are the best option for your product, it is important to speak with your packaging supplier.",
      },
      {
        question: "How are Agro-Chemical products placed within aluminium collapsible tubes?",
    ...
    faqs = [
      {
        question: "What type of industrial product works well with aluminium collapsible tubes, canisters and bottles?",
        answer: "Adhesive, silicon gasket Maker, super glue will be filled inside bottles and canisters are just a few of the industrial goods that work well in aluminium collapsible tubes, canisters and bottles. If you want to know whether aluminium collapsible tubes, canisters and bottles are the best option for your particular product, it's important you speak with our team.",
      },
      {
        ...
        answer:"Our high-tech processes provide us with the opportunity to offer our clients with a variety of closure options for aluminium collapsible tubes, canisters and bottles. For tubes caps options are spike, conical, 3 piece, cylinder spike, reverse spike caps. For tablet canisters comes with desiccant and pushed caps and aluminium bottles comes with pump, flip-top caps.",
      },
      {
        question: "How is aluminium collapsible tube, canisters and bottles better than other types of packaging such as plastic or glass for industrial and agro-chemical products?",
        answer:"Aluminium collapsible tubes, canisters and bottles are less likely to break or leak than glass or plastic tubes, making them a more dependable option for industrial and agro-chemical products. In addition, aluminium collapsible tubes, canisters and bottles are more cost-effective than glass and plastic alternatives, as they require less energy to manufacture and transport.",
      }
    ];
  } else {
    faqs = [
