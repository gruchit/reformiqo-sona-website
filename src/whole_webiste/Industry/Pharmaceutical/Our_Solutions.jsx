                            ...
                            <div className='col-xl-4  col-lg-4 col-md-6   mt-lg-0'>
                                <div className=' d-flex justify-content-center'>
                                    <div className='OurSoluCard  flex-column  mt-5 mt-sm-5 mt-md-0 mt-lg-0 mt-xl-0 mt-xxl-0'>
                                        ...
                                        {Type === "Cosm" ?
                                            <>
                                                <img src={HighTech} alt="" className='OurSoluImg' />
                                                <div className='mt-5'>
                                            ...
                                            Type === "Nut" ?
                                                <>
                                                    <img src={Extensive} alt="" className='OurSoluImg' />
                                                    <div className='mt-5'>
                                                ...
                                                Type === "Indu" ?
                                                    <>
                                                        <img src={Highest} alt="" className='OurSoluImg' />
                                                        <div className='mt-5'>
                            ...
                            <div className='col-xl-4  col-lg-4 col-md-6  mt-lg-0'>
                                <div className=' d-flex justify-content-center'>
                                    <div className='OurSoluCard   flex-column  mt-5 mt-sm-5 mt-md-0 mt-lg-5 mt-xl-5 mt-xxl-5'>
                                        {Type === "Cosm" ?
                                            <>
                                                <img src={Widerange} alt="" className='OurSoluImg' />
                                                <div className='mt-5'>
                                            ...
                                            Type === "Nut" ?
                                                <>
                                                    <img src={Quality} alt="" className='OurSoluImg' />
                                                    <div className='mt-5'>
                                                ...
                                                Type === "Indu" ?
                                                    <>
                                                        <img src={Configurability} alt="" className='OurSoluImg' />
                                                        <div className='mt-5'>
                                                    ...
                                                    : <>
                                                        <img src={Customizable} alt="" className='OurSoluImg' />
                                                        <div className='mt-5'>
                            ...
                            <div className='col-xl-4  col-lg-4 col-md-6  mt-lg-0'>
                                <div className=' d-flex justify-content-center'>
                                    <div className='OurSoluCard  flex-column  mt-5 mt-sm-5 mt-md-5 mt-lg-0 mt-xl-0 mt-xxl-0'>
                                        {Type === "Cosm" ?
                                            <>
                                                <img src={Environmentally} alt="" className='OurSoluImg' />
                                                <div className='mt-5'>
                                            ...
                                            Type === "Nut" ?
                                                <>
                                                    <img src={Cost} alt="" className='OurSoluImg' />
                                                    <div className='mt-5'>
                                                ...
                                                Type === "Indu" ?
                                                    <>
                                                        <img src={Industryexpertise} alt="" className='OurSoluImg' />
                                                        <div className='mt-5'>
                                                    ...
                                                    : <>
                                                        <img src={Regulatory} alt="" className='OurSoluImg' />
                                                        <div className='mt-5'>
