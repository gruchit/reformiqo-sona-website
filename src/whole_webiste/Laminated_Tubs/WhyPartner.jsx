            ...
            <div className='WhyPartner'>
                <div className='flex-column'>
                    ...
                    <div className='WhyPartner_ditals'>
                        <h2 className="text-center sans_light">Why Partner with Us?</h2>
            ...
            <div className='WhyPartnerDown d-flex'>
                ...
                <div className='WhyPartnerTabs flex-column me-auto'>
                    <div className='d-flex my-2 ms-4'>
                        ...
                        <div>
                            <h5 className='mb-0 sans_light '>Exceptional Quality:</h5>
                    ...
                    <div className='d-flex my-2 ms-4'>
                        ...
                        <div>
                            <h5 className='mb-0 sans_light'>Custom Solutions:</h5>
                            <p className='sans_light text-secondary'>
                    ...
                    <div className='d-flex my-2 ms-4'>
                        ...
                        <div>
                            <h5 className='mb-0 sans_light'>Tailored Solutions for Every Sector:</h5>
                            <p className='sans_light text-secondary'>
                    ...
                    <div className='d-flex my-2 ms-4'>
                        ...
                        <div>
                            <h5 className='mb-0 sans_light'>Competitive Pricing and Value:</h5>
                            <p className='sans_light text-secondary'>
                    ...
                    <div className='d-flex my-2 ms-4'>
                        ...
                        <div>
                            <h5 className='mb-0 sans_light'>Reliable Delivery:</h5>
                            <p className='sans_light text-secondary'>
