    ...
    return (
        <>
            ...
            <div className='WhyPartnerDown d-flex'>
                <img src={Arrow} alt=""  loading='lazy' data-aos="fade-left"/>
                <div className='WhyPartnerTabs flex-column me-auto' data-aos="fade-right">
                    ...
                    <div className='d-flex my-2 ms-4'>
                        ...
                        <div>
                            ...
                            <p className='sans_light text-secondary'>
                            We are committed to providing exceptional value without compromising on quality. Our competitive pricing structure ensures that you receive top-quality laminated tubes at a cost-effective rate. We focus on delivering value through efficiency, innovation, and unparalleled customer service.
                            </p>
                        </div>
                    </div>
                    <div className='d-flex my-2 ms-4'>
