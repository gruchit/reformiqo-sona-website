                        ...
                        <div className='row d-flex justify-content-center'>
                            ...
                            <div className='col-xl-4 mt-5 col-lg-4 col-md-6 d-flex justify-content-center'>
                                <div className='WhySonaCards1'>
                                    ...
                                    <p className='sans_light pt-2 text-secondary'>Stand out on the shelf with our high-resolution printing capabilities. Our advanced printing technology allows for vibrant, eye-catching designs that enhance your product’s appeal and capture consumer attention. From intricate details to bold graphics, we deliver excellence in every print.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className='SonaLngCrd '>
                        <div className='row d-flex justify-content-center'>
