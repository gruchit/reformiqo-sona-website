            ...
            <div className="Know_More flex-column">
                ...
                <div className='container' 
                    ...
                    <p className="text-center sans_light text-secondary">
                        We, at Sona Extrusions, are one of the leading producers and exporters of premium aluminum
                        collapsible tubes, containers, and aluminum bottles/flasks. Dependable product quality and prompt
            ...
            <div className="Know_More_tabs d-flex justify-content-start"  data-aos="fade-right" data-aos-duration="600" data-aos-offset="200">
                <div className="Know_More_tabsInner">
                    ...
                    <div className="KnowMoreTabs">
                        {activeTab === 'Mission' && (
                            <div className="text-secondary sans_light" data-aos="fade-up" data-aos-duration="500" data-aos-once="true" mirror="true">
                                    <p className=''>Our mission is to provide high-quality and innovative packaging solutions that meet the diverse needs of our clients. We are dedicated to manufacturing and delivering premium aluminum packaging solutions that are safe, reliable, and environmentally sustainable. </p>
                        ...
                        {activeTab === 'Vision' && (
                            <div className=" text-secondary sans_light" data-aos="fade-up" data-aos-duration="500" data-aos-once="true" mirror="true">
                                <p className='' >Our vision is to be a global leader in the packaging industry, recognized for our innovative and sustainable solutions. </p>
                                 ...
                                 <p>   We aim to continuously enhance the customer experience by providing a diverse range of premium aluminum packaging solutions that meet their specific needs. Through our commitment to excellence, we will maintain our position as a preferred supplier to clients in a variety of industries.</p>
                        ...
                        {activeTab === 'CoreValues' && (
                            <div className=" text-secondary sans_light" data-aos="fade-up" data-aos-duration="500" data-aos-once="true" mirror="true">
                                <p className=''>We understand the needs of our customers and offering solutions that surpass expectations while maintaining strict quality standards. We continue to make investments in research and development to enhance our processes and products to offer competitive and innovative solutions to new geographies.</p>
                                <ol className=''>
