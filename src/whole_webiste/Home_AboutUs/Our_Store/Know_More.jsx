        ...
        <>
            <div className="Know_More flex-column">
                <div className="Know_More_imgBol d-flex justify-content-center">
                    <img src={Single_BlackBol_Line} alt="Line Decoration" className='MoreImgBolDoted' loading='lazy'
                        data-aos="zoom-in-up"
                        data-aos-offset="50"
                        data-aos-delay="500"
            ...
            <div className="Know_More_tabs d-flex justify-content-start">
                ...
                >
                    ...
                    <div className="KnowMoreTabs">
                        {/* {activeTab === 'Mission' && ( */}
                        <div className={`tab-content text-secondary ${activeTab === 'Mission' ? 'show' : ''}`}>
                            ...
                            <p
                                 > We strive to be a trusted and responsible partner in the packaging industry, and to play a leading role in promoting the use of environmentally-friendly packaging solutions.</p>
                        </div>
                        {/* )} */}
                        {/* {activeTab === 'Vision' && ( */}
                        <div className={`tab-content text-secondary ${activeTab === 'Vision' ? 'show' : ''}`}>
                        ...
                        <div className={`tab-content text-secondary ${activeTab === 'CoreValues' ? 'show' : ''}`}>
                        ...
                        <div className={`tab-content text-secondary ${activeTab === 'WhyChooseUs' ? 'show' : ''}`}>
