                        ...
                        <div className='row d-flex justify-content-center'>
                            <div className='col-lg-6 col-md-12 mt-5 d-flex justify-content-center'>
                                <div className='EmissionCard '>
                                    <h2 className='mb-4 sans_light'>CO<sub>2</sub> Emission</h2>
                                    ...
                                    <div className='d-flex'>
                                        <ul className='flex-column list-unstyled justify-content-evenly mb-0 sans_light'>
                            ...
                            <div className='col-lg-6 col-md-12 mt-5 d-flex justify-content-center'>
                                <div className='EmissionCard '>
                                    <h2 className='mb-4 sans_light'>Recycle</h2>
