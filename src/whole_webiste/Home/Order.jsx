                ...
                <div className=''>
                    ...
                    <div className='d-lg-none d-md-none d-sm-none d-none d-xl-block'>
                        <div className='Order_images d-flex justify-content-center '>
                            ...
                            >
                                <div className='Order_images_box_detals'>
                                    <img src={Industries} alt="" className='' loading='lazy'/>
                                    <h4 className='text-center mb-3 sans_Medium'>Industries We Serve</h4>
                                </div>
                            ...
                            >
                                <div className='Order_images_box_detals'>
                                    <img src={Certifications} alt="" className='' loading='lazy'/>
                                    <h4 className='text-center mb-3 sans_Medium'>Certifications</h4>
                                </div>
